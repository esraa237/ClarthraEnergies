...
import { AddAdminDto, AddAdminResponseDto, CompleteProfileDto, CompleteProfileResponseDto } from './dto/user.dto';
...
export class UsersController {
  ...
  @Roles(Role.SUPER_ADMIN)
  @ApiBearerAuth('access-token')
  @ApiOperation({ summary: 'Resend profile completion email' })
